...
유준오(Junoh Yu) · 성균관대학교 영상학과 · 청주대학교 디지털미디어디자인학과

두 대학의 수업 결과물을 모은 한 장짜리 아카이브 웹사이트입니다.
최상위에서 **성균관대학교 / 청주대학교** 두 탭으로 나뉘고, 각 대학 안에서 다시 과목 탭으로 나뉩니다.

- **성균관대학교** (2026년 1학기) — 캡스톤 디자인 / 몰입형 내러티브 & 인터랙션 디자인 / AI 기반 인터랙티브 영상 / 1st N.I.M.A 전시
- **청주대학교** (2025.10.22 중간발표) — 인터랙션 디자인 1분기 / 2분기
...
```
.
├── index.html          # 사이트 전체 (HTML · CSS · JS 인라인, 약 168KB)
├── assets/
│   └── img/            # 썸네일·스틸컷 142장 (JPEG·PNG, 약 5.9MB)
...
- [ ] 미기재 작품명 4건 보완 (몰입형 2팀·7팀, AI 5팀, 청주대 Q2 강유림 팀)
- [ ] 청주대 Q2 “맹구와 나” 팀 팀원 명단 확인
- [ ] 청주대 미분류 영상 10건의 소속 팀 확인
